...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,DownloadManagerListener {
...
//    public boolean delete(int token, boolean deleteTaskFile);
    ...
    public void onDownloadProcess(final long taskId,final double percent,final long downloadedLength) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity.this,taskId+":onDownloadProcess" +" percent:"+percent + " downloadedLength:"+downloadedLength,Toast.LENGTH_SHORT).show();
            }
        });
    }
